...
for (tsi in 1:1428){
  ...
  if (observations>80){
    ...
    # print(paste0(tsi, "- Saving SSEinputnodes.csv..."))
    # write.csv(SSEinputnodes, paste0(tsi, "_SSEinputnodes.csv"))

    BestInputNodes<-which.min(SSEinputnodes) #best length of input nodes
    print(paste0(tsi, " - ", BestInputNodes))
    inp_nodes <- c(inp_nodes, BestInputNodes)
...
print(paste0("Average num input nodes: ", mean(inp_nodes)))
